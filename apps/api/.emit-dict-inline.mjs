...
const code = fs.readFileSync(join(__dirname, 'dictionary-module-demo-tsx.txt'), 'utf8');
const mock = {
  readOnly: false,
...
fs.writeFileSync(join(__dirname, 'dictionary-ui-spec.json'), JSON.stringify(out, null, 0), 'utf8');
